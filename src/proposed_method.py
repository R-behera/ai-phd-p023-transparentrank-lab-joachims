...
METHOD_SPEC = {
    "algorithm_id": "P023-Joachims-InformationRetrieval",
    "algorithm_name": "JoachimsTemporalInformationRetrievalStressAgent",
    "project_family": "retrieval",
    "professor": "Thorsten Joachims",
    "focus": "information retrieval",
    "core_mechanism": "prioritizes ranking cases where relevance, evidence, and controllability diverge",
    "decision_rule": "Rank seed cases by retrieval-specific priority score with Joachims-aligned focus term 'information retrieval'.",

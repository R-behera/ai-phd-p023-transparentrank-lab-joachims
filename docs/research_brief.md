...
TransparentRank Lab: information retrieval for Joachims-Aligned Research

## Motivation

This project targets the intersection of **ML, information retrieval, learning-to-rank, SVMs** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Thorsten Joachims's research area.
...
BEIR/MS MARCO, Amazon/Yelp/MovieLens, preference drift splits, and a lightweight user-study protocol.

Advisor-specific slice: **ML, information retrieval, learning-to-rank, SVMs**.

## Baselines

BM25, dense retrieval, learning-to-rank, matrix factorization, neural recommender, and explanation-free ranker.
...
NDCG, MAP, recall@k, diversity, controllability, explanation helpfulness, and drift robustness.
